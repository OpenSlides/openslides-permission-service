...
func User(dp dataprovider.DataProvider) perm.ConnecterFunc {
	...
	return func(s perm.HandlerStore) {
		s.RegisterAction("user.create", perm.WriteCheckerFunc(u.create))
		s.RegisterAction("user.update_self", perm.WriteCheckerFunc(u.updateSelf))
		s.RegisterAction("user.update", perm.WriteCheckerFunc(u.update))
		s.RegisterAction("user.set_password_self", perm.WriteCheckerFunc(u.passwordSelf))
		s.RegisterAction("user.reset_password_to_default", perm.WriteCheckerFunc(u.update))
		s.RegisterAction("user.generate_new_password", perm.WriteCheckerFunc(u.update))
		s.RegisterAction("user.set_password", perm.WriteCheckerFunc(u.update))
		s.RegisterAction("user.delete", perm.WriteCheckerFunc(u.update))

		s.RegisterRestricter("user", perm.ReadCheckerFunc(u.read))
	}
}
